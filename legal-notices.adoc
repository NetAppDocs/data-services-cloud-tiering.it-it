...
* https://docs.netapp.com/us-en/console-setup-admin/media/notice.pdf["Avviso per la console NetApp"^]
* link:media/notice_cloud_tiering.pdf["Avviso per il cloud tiering"^]
